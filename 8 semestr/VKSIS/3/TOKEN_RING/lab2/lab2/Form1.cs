    ...
    public partial class Form1 : Form
    {
        ...
        private void connectButton_Click(object sender, EventArgs e)
        {
            ...
            if (!machine.connected)
            {
                ...
                infiniteCheckBox.Enabled = false;
                withoutPriorCheckBox.Enabled = false;
                connectButton.Text = "Disconnect";
                wantToSendLabel.Text = "";
                sendButton.Enabled = true;
                machine.baseMarker = true;
                machine.isMonitor = (Boolean) monitorCheckBox.Checked;
                machine.isInfinite = (Boolean)infiniteCheckBox.Checked;
                machine.withoutPrior = (Boolean)withoutPriorCheckBox.Checked;
        ...
        private void sendButton_Click(object sender, EventArgs e)
        {
            ...
            if (machine.isMonitor && !withoutPriorCheckBox.Checked)
            {
                machine.sendMarker();
            }
        }
