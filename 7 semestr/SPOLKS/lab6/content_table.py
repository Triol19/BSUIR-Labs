...
class Connection(object):
    ...
    of socket object, address info, associated
...
class ConnTable(object):
    ...
    """connections table holds connection units described above"""
    ...
    def remove(self, socket):
        ...
        """removes connection from list and delete it"""

        #conn = self.get(socket)
        #del conn
        self.table = [el for el in self.table if el.socket != socket]  # delete from table
        #print self.table
        return True
